...
class Player(turtle.Turtle):
    def __init__(self, platforms):
        ...
        self.dy = 0
        self.gravity = 0.2
        self.pl_nr = 0 # Showing current platform index
    ...
    def jump_up(self):
        if self.dy == 0 and self.flat != True:
            self.dy = 5.5
            self.gravity = 0.2
    ...
    def animate(self):
        self.counter += 1
        if player.dx<0 and self.flat != True:
            if self.s == 'stick-L1.gif' and self.counter%10 == 0:
                self.s = 'stick-L2.gif'
                self.shape(self.s)
            elif player.s == 'stick-L2.gif' and self.counter%10 == 0:
                self.s = 'stick-L3.gif'
                self.shape(self.s)
            elif self.s == 'stick-L3.gif' and self.counter%10 == 0:
                self.s = 'stick-L1.gif'
                self.shape(self.s)

        elif player.dx > 0 and self.flat != True:
            if self.s == 'stick-R1.gif' and self.counter%10 == 0:
                self.s = 'stick-R2.gif'
                self.shape(self.s)
            elif self.s == 'stick-R2.gif' and self.counter%10 == 0:
                self.s = 'stick-R3.gif'
                self.shape(self.s)
            elif self.s == 'stick-R3.gif' and self.counter%10 == 0:
                self.s = 'stick-R1.gif'
                self.shape(self.s)
