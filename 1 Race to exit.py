# Simple racet to the exit game J Joubert 27 December 2019
...
class Player(turtle.Turtle):
    ...
    def move(self):
        ...
        for i in platforms:
            ...
            if within_platform(player, i) and player.dy<0: # only when going down
                self.sety(i.ycor()+20)
                self.dy = 0
                self.gravity = 0
    ...
    def jump_up(self):
        if self.dy == 0:
            ...
            print('You cannot jump in the air or when falling off platform')


    def animate(self):
        if player.dx<0:
            if player.s == 'stick-L1.gif' and counter%10 == 0:
